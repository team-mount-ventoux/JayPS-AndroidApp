...
public class VirtualPebbleService extends Service{
    ...
    public void onCreate() {
        ...
        ackReceiver = new PebbleKit.PebbleAckReceiver(WATCH_UUID) {
            @Override
        ...
        nackReceiver = new PebbleKit.PebbleNackReceiver(WATCH_UUID) {
            @Override
                ...
                public void run() {
                    synchronized (isMessagePending) {
                        ...
                        synchronized (messageQueue) {
                            ...
                            PebbleKit.sendDataToPebbleWithTransactionId(getApplicationContext(), WATCH_UUID, data, transID);
                        }
